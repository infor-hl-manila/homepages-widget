...
Soho.Locale.addCulture('nl-NL', {
  ...
  messages: {
    ...
    AdditionalItems: { id: 'AdditionalItems', value: 'Extra artikelen', comment: 'Button tooltip used in a list of movable items' },
    ...
    DiscretionaryTimeOff: { id: 'DiscretionaryTimeOff', value: 'Discreet verlof', comment: 'As in work time off' },
    ...
    Locale: { id: 'Locale', value: 'Landinstelling', comment: 'The users locale string for example en-US, it-It' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} records per pagina', comment: 'Dropdown allows the user to select how many visible records {} shows select value.' },
    ...
    Results: { id: 'Results', value: 'Resultaten', comment: 'As in showing N Results (plural) in a List' },
    ...
    StepsCompleted: { id: 'StepsCompleted', value: '{0} van {1} stappen is/zijn voltooid', comment: 'steps of a wizard/chart' },
    ...
    UpComingEvents: { id: 'UpComingEvent', value: 'Komende events', comment: 'List of upcoming calendar events' },
