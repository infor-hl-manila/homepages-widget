...
Soho.Locale.addCulture('id-ID', {
  ...
  messages: {
    ...
    Locale: { id: 'Locale', value: 'Lokasi', comment: 'The users locale string for example en-US, it-It' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} Rekaman per halaman', comment: 'Dropdown allows the user to select how many visible records {} shows select value.' },
    ...
    UpComingEvents: { id: 'UpComingEvent', value: 'Event Mendatang', comment: 'List of upcoming calendar events' },
