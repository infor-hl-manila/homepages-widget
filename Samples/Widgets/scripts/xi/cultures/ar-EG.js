...
Soho.Locale.addCulture('ar-EG', {
  ...
  messages: {
    ...
    Locale: { id: 'Locale', value: 'الإعدادات المحلية', comment: 'The users locale string for example en-US, it-It' },
    ...
    RecordsPerPage: { id: 'RecordsPerPage', value: '{0} سجل/سجلات لكل صفحة', comment: 'Dropdown allows the user to select how many visible records {} shows select value.' },
    ...
    Result: { id: 'Result', value: 'النتيجة', comment: 'Showing a single result in a List' },
    Results: { id: 'Results', value: 'النتائج', comment: 'As in showing N Results (plural) in a List' },
    ...
    UpComingEvents: { id: 'UpComingEvent', value: 'الأحداث المقبلة', comment: 'List of upcoming calendar events' },
    ...
    Week: { id: 'Week', value: 'الأسبوع', comment: 'Shows a view of the current weeks events' },
