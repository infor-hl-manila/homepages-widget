...
define(["require", "exports", "@angular/core", "lime", "../components/campaign-workspace.component", "../date.pipe", "../services/campaign-workspace.service", "../services/data.service"], function (require, exports, core_1, lime_1, campaign_workspace_component_1, date_pipe_1, campaign_workspace_service_1, data_service_1) {
    ...
    var CampaignsListComponent = /** @class */ (function () {
        ...
        CampaignsListComponent.prototype.showDialogWorkspace = function (ID, title, showCampaign, showStage, StageID, StageCampaignID) {
        ...
        CampaignsListComponent.prototype.webbAppLink = function () {
            var form = encodeURIComponent("CRMCampaign(SETVARVALUES(VarAppliedNamedFilter=My Campaigns,InitialCommand=Refresh))");
            var url = "?LogicalId={logicalId}&form=" + form;
            this.widgetContext.launch({ url: url });
        };
        CampaignsListComponent.prototype.onSelectDateSort = function (sort) {
            ...
            this.container.sort(function (a, b) {
                var dateA = new Date(_this.dateTimePipe.transform(a.StartDate));
                var dateB = new Date(_this.dateTimePipe.transform(b.StartDate));
                var date1 = dateA.getTime();
                var date2 = dateB.getTime();
        ...
        CampaignsListComponent.prototype.onSelectSort = function (sort) {
            var _this = this;
            ...
            this.container.sort(function (a, b) {
                var dateA = new Date(_this.dateTimePipe.transform(a.StartDate));
                var dateB = new Date(_this.dateTimePipe.transform(b.StartDate));
                var endDateA = new Date(_this.dateTimePipe.transform(a.EndDate));
                var endDateB = new Date(_this.dateTimePipe.transform(b.EndDate));
                var date1 = dateA.getTime();
                var date2 = dateB.getTime();
                var endDate1 = endDateA.getTime();
                var endDate2 = endDateB.getTime();
                if (sort === "startDateLatest") {
                    return date2 - date1;
                }
                else if (sort === "startDateOldest") {
        ...
        CampaignsListComponent.prototype.toggleSort = function () {
            this.isAscendingSort ? this.sortAsc() : this.sortDesc();
        };
        CampaignsListComponent.prototype.sortAsc = function () {
            var _this = this;
            this.isAscendingSort = false;
            this.container.sort(function (c1, c2) {
                var dateA = new Date(_this.dateTimePipe.transform(c1.StartDate));
                var dateB = new Date(_this.dateTimePipe.transform(c2.StartDate));
                var endDateA = new Date(_this.dateTimePipe.transform(c1.EndDate));
                var endDateB = new Date(_this.dateTimePipe.transform(c2.EndDate));
                var date1 = dateA.getTime();
                var date2 = dateB.getTime();
                var endDate1 = endDateA.getTime();
                var endDate2 = endDateB.getTime();
        ...
        CampaignsListComponent.prototype.sortDesc = function () {
            var _this = this;
            this.isAscendingSort = true;
            this.container.sort(function (c1, c2) {
                var dateA = new Date(_this.dateTimePipe.transform(c1.StartDate));
        ...
        CampaignsListComponent.prototype.onSelectFilter = function (filter) {
            ...
            var campaignUrl = "CRMCE/IDORequestService/MGRestService.svc/json/CRMCampaign/adv?props=ID,Name,Status,LaunchedOn,DerLaunchStatus,DerManagerName,StartDate,EndDate,DerTargetCount,DerStageCount,DerStepCount,Owner,Description,Objectives,CallToAction,LeadSource,Type,Code";
        ...
        CampaignsListComponent.prototype.loadCampaigns = function (dataUrl) {
            var _this = this;
            this.dataSet = [];
            this.dataService.getCampaigns("" + encodeURI(dataUrl)).subscribe(function (response) {
